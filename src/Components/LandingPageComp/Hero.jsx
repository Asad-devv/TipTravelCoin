...
const Hero = () => {
  ...
  return (
    <section className="relative  bg-[#3B1C08] text-white min-h-screen pt-[60px] overflow-hidden">
      <div className="absolute top-0 right-0 z-0 w-1/2 h-1/2 bg-blue-500/20 blur-[120px] rounded-full" />
      <div className="absolute bottom-0 left-0 z-0  w-1/2 h-1/2 bg-yellow-500/20 blur-[120px] rounded-full" />

      <div className="flex z-50 pt-10 px-20 h-[90vh] flex-col lg:flex-row items-center justify-between gap-12 min-h-[60vh] text-center lg:text-left">
        <div className="flex flex-col gap-10 items-start flex-1">
          ...
          <div className="flex  gap-4 mt-4">
            <Link to="/buy" className="z-50 hover:bg-transparent hover:border-white hover:border hover:text-white px-6 py-2 rounded-lg font-semibold bg-yellow-300 text-black transition-colors">
              Buy $DEM
            </Link>
            <a
              href={whitepaper}
